...
int main (int argc, char *argv[])
{
  ...
  LocalLink.SetChannelAttribute ("Delay", StringValue (access_delay));
    ...
    double alpha=50/(num_flows);
    ns3::MobilityHelper mobilityManager;
    mobilityManager.SetPositionAllocator("ns3::GridPositionAllocator", "MinX", ns3::DoubleValue(50.0),"MinY", ns3::DoubleValue(50.0),
    "DeltaX", ns3::DoubleValue(alpha), "DeltaY", ns3::DoubleValue(5.0), "GridWidth", ns3::UintegerValue(num_flows),
    "LayoutType", ns3::StringValue("RowFirst"));
    //mobilityManager.SetMobilityModel("ns3::StaticMobilityModel");
    mobilityManager.Install(sources);
  ...
  if (tracing)
    {
      ...
      Simulator::Schedule (Seconds (0.00001), &TraceCwnd, prefix_file_name + "2-cwnd.data");
      Simulator::Schedule (Seconds (0.00001), &TraceSsThresh, prefix_file_name + "2-ssth.data");
      Simulator::Schedule (Seconds (0.00001), &TraceRtt, prefix_file_name + "2-rtt.data");
      Simulator::Schedule (Seconds (0.00001), &TraceRto, prefix_file_name + "2-rto.data");
      Simulator::Schedule (Seconds (0.00001), &TraceNextTx, prefix_file_name + "2-next-tx.data");
      Simulator::Schedule (Seconds (0.00001), &TraceInFlight, prefix_file_name + "2-inflight.data");
...
pcap = true;
  if (pcap)
    {
      ...
      LocalLink.EnablePcap (prefix_file_name, sources, true);
    }
  ...
  if (flow_monitor)
    {
      flowHelper.SerializeToXmlFile (prefix_file_name + "2.flowmonitor", true, true);
    }
